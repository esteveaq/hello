...
Example of data analysis with categorical data. We use random generated M&A deals with a few attributes : sectors, regions, deal size. Basic exploratory data analysis.
:::
