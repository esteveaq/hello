...
categories: [memo, R]
image: logo.png
description: "Generating PowerPoint slides using R (personal memo)"
format:
  html:
...
Sometimes I might need to present reports in a PowerPoint format.\
This memo shows how to use R & the tidyverse to generate simple automated PPT slides from a dataset.\
It was a fun way to experiment with functions.
:::
...
# Map the function and store output
